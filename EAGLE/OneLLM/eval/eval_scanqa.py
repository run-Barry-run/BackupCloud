...
class CaptionDataset(Dataset):
    def __init__(self) -> None:
        super().__init__()
        self.datas = json.load(open('/home1/hxl/disk/EAGLE/dataset/ScanQA/ScanQA_v1.0_val.json'))
        self.video_path = '/home1/hxl/disk/EAGLE/dataset/ScanNet/scannetv2/tasks/scannet_frames_25k_mp4'
...
if __name__ == "__main__":
    ...
    answer_path = "../output/eval/onellm/eval_scanqa.json"
